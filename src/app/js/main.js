$(function(){
  ...
  // definition of our variable to resize the points
    var fontSizeMultiplier = 0.45;
    ...
    function drawName(name, letterColors) {
        ...
        for (var j = 0; j < g.length; j++) {
            ...
            g[j].curPos.y = (canvasHeight / 2 - 105*fontSizeMultiplier) + g[j].curPos.y;
            g[j].originalPos.x = (canvasWidth / 2 - offset / 2) + g[j].originalPos.x;
            g[j].originalPos.y = (canvasHeight / 2 - 105*fontSizeMultiplier) + g[j].originalPos.y;
        }
